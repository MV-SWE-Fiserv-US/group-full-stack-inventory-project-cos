...
describe("Items", () => {
  ...
  describe("PUT", () => {
    test("PUT /items/:id should return a correct data for single item", async () => {
      ...
      await request(app).put("/items/16").send(body);
      const response = await request(app).get("/items/16");
...
describe("next(errors)", () => {
  describe("Items", () => {
    test("GET /items should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Item, "findAll").mockImplementation(() => {
        throw error;
      });
    ...
    test("GET /items/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Item, "findAll").mockImplementation(() => {
        throw error;
      });
    ...
    test("POST /items should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Item, "create").mockImplementation(() => {
        throw error;
      });
    ...
    test("PUT /items/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Item, "update").mockImplementation(() => {
        throw error;
      });
    ...
    test("DELETE /items/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Item, "destroy").mockImplementation(() => {
        throw error;
      });
  ...
  describe("Users", () => {
    test("GET /users should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
    ...
    test("GET /:id/orders should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
    ...
    test("GET /users/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(User, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("POST /users should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
    ...
    test("PUT /users/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(User, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("PUT /users/:id/addToCart/:itemId should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(User, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("PUT /users/:id/updateCart should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(User, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("DELETE /users/:id/ should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
  ...
  describe("Orders", () => {
    test("GET /orders/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Order, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("GET /orders should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
    ...
    test("POST /orders/:userId should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Order, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("POST /orders should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
    ...
    test("PUT /orders/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
      jest.spyOn(Order, "findByPk").mockImplementation(() => {
        throw error;
      });
    ...
    test("DELETE /orders/:id should call next(error) when an error occurs", async () => {
      const error = new Error("Test error");
